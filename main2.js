...
class Player {
    ...
    _setupTweens() {
        ...
        this.tweens.volumeKnob = TweenMax.fromTo(this.actors.volumeKnob, 1, { y: (this.actors.volumeTrack.getBBox().height / 2) }, { y: -1 * (this.actors.volumeTrack.getBBox().height / 2), ease: Linear.easeNone, paused: true });
        this.tweens.volumeLightLevel = TweenMax.fromTo(this.actors.volumeLightLevel, 1, { scaleY: 0.0, transformOrigin: '50% 100%' }, { scaleY: 1, paused: true, transformOrigin: '50% 100%', ease: Linear.easeNone });
